...
<html>
    ...
    <body>
        ...
        <table align='center' border="1" width="50%" >
            ...
            <%                int i = 0;
                String selQry = "select * from tbl_booking b inner join tbl_cart c on c.booking_id=b.booking_id inner join tbl_user u on u.user_id=b.user_id inner join tbl_product p on p.product_id=c.product_id where buisness_id='" + session.getAttribute("bid") + "' and booking_status>0";
