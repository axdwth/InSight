                    ...
                    <nav>
                        <ul>
                            ...
                            <li class="dropdown-holder">
                              ...
                              <ul class="hb-dropdown">
                                  <li><a href="Bookings.jsp">View Orders</a></li>
                                  <li><a href="ViewReview.jsp">Reviews</a></li>
                                  <li><a href="Complaint.jsp">Add complaint</a></li>
                                    </ul> 
                                     
                                   <li><a href="Cart.jsp">View Cart</a>
                                   <li><a href="ViewBusiness.jsp">See business</a>
                        </ul>
                        ...
                        <div class="single-slide align-center-left animation-style-01 bg-4">
                            ...
                            <div class="slider-content">
                                ...
                                <div class="default-btn slide-btn">
                                    <a class="links" href="ViewBusiness.jsp">Shopping Now</a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="product_desc">
                                            ...
                                            <div class="add-actions">
                                                <ul class="add-actions-link">
                                                    <li class="add-cart active" onclick="addCart('<%=rs.getString("product_id")%>')">Add to cart</a></li>
