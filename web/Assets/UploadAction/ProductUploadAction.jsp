...
//                }
        ...
        String InsQry = "INSERT INTO `tbl_product`( `product_name`, `product_details`, `product_photo`,`product_price`,`subcategory_id`,`buisness_id`)"
                + "values('" + value[0] + "','" + value[1] + "','" + photo + "','" + value[2] + "','" + value[4] + "','"+session.getAttribute("bid")+"')";
...
<script type="text/javascript">
    alert("Product added ");
    setTimeout(function() {
        window.location.href = '../../Business/Product.jsp'
