<%-- 
    ...
    Created on : 27 Jan, 2024, 11:47:06 AM
    Author     : 91907
--%>
    ...
    if (isMultipart) {
        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            } else//when it is an image or multipart
            {
                ...
                if (field_name.equals("file_license"))//write the name of image here it is img_product
                {
                    ...
                    License = "Businesslicense_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                ...
                if (field_name.equals("file_logo"))//write the name of image here it is img_product
                {
                   ...
                   //setting path to store image
                    ...
                    Logo = "businessLogo_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                    //creating a file object
        ...
        String InsQry = "INSERT INTO `tbl_buisness`( `buisness_name`, `buisness_email`, `buisness_contact`,`buisness_logo`,`buisness_address`,`buisness_license`,`type_id`,`place_id`,`buisness_password`)"
                + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + Logo + "','" + value[3] + "','" + License + "','" + value[4]+ "','" + value[7] + "','"+value[8]+"')";
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../Admin/BusinessRegistration.jsp';
